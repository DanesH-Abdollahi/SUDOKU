...
#     while lines_drawn < 6:
#         pygame.draw.line(
#             screen, black, (pos, buffer), (pos, width - buffer - 1), minor_grid_size
#         )
#         pygame.draw.line(
#             screen, black, (buffer, pos), (width - buffer - 1, pos), minor_grid_size
#         )
...
#     for pos in range(
#         buffer + major_grid_size // 2,
#         width,
#         cell_size * 3 + minor_grid_size * 2 + major_grid_size,
#     ):
#         pygame.draw.line(
#             screen, black, (pos, buffer), (pos, width - buffer - 1), major_grid_size
#         )
#         pygame.draw.line(
#             screen, black, (buffer, pos), (width - buffer - 1, pos), major_grid_size
#         )
...
#                 else:
#                     text = font.render(f"{board.board[row][col].value}", 1, red)
...
#             if (
#                 value in row_sets[row]
#                 or value in col_sets[col]
#                 or value in box_sets[box]
#             ):
#                 return False
...
#                 if (
#                     active_cell
#                     and not game.board[active_cell.row][active_cell.col].editable
#                 ):
#                     active_cell = None
